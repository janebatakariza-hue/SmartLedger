...
export default function InventoryScreen() {
  ...
  const stockValue = app.inventory.reduce(
    (sum, i) => sum + i.quantity_on_hand * i.unit_price,
    0,
  );
                ...
                <View style={{ flex: 1 }}>
                  {item.is_low_stock && (
                    ...
                    >
                      ...
                      >
                        {item.quantity_on_hand === 0 ? "CRITICAL" : "LOW STOCK"}
                      </Text>
                    </View>
                  )}
                  <Text
                  ...
                  <Text
                    style={{ fontSize: 11, color: GRAY_DARK, marginTop: 2 }}
                  >
                    SKU: {item.sku}
                  </Text>
                </View>
        ...
        >
          <Text style={{ fontSize: 12, color: GRAY_DARK }}>
            ...
            <Text style={{ fontWeight: "700", color: BLACK }}>
              RWF {(stockValue / 1000000).toFixed(1)}M
            </Text>
          </Text>
          <Text style={{ fontSize: 12, color: GRAY_DARK }}>
            Low Stock:{" "}
